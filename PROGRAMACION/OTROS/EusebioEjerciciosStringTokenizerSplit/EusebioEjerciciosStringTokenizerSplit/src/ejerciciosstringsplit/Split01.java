...
public class Split01 {
    ...
    public static void main(String[] args) {
        System.out.println("Inicio de la aplicación\n");                        //VERSION STRING SPLIT DEL CÓDIGO DEL EJERCICIO 1
        System.out.println("Pueba del método estático compruebaFecha() "
                + "utilizando el método split de la clase String");
        compruebaFecha();                                                       //Main solo se encanga de lanzar el método compruebaFecha()
    ...
    public static void compruebaFecha(){                                        //Método que comprueba una fecha introducida en formato MM/DD/AA
        ...
        int nElem;                                                              //int para el número de partes
        ...
        do{
            ...
            String[] fecha=fechaP.split("/");                                   //Array de String resultado de dividir en partes fechaP, a partir de '/' tratado como String
            nElem=fecha.length;                                                 //Extraemos el número de partes, que será el tamaño del array fecha obtenido de split
            if(nElem!=3)                                                        //Si no hay exactamente 3 partes, error de formato
                System.out.println("Debe utilizar un formato de fecha válido");                          
            else{
                wrongFormat=false;                                              //Hay 3 partes, desactivamos el error de formato                 
